...
let handler = async (m, { conn, args, usedPrefix, command, isOwner }) => {
	...
	let conns = global.conn	if(conn.user.jid !== conns.user.jid) return m.reply('Tidak bisa membuat Bot pada user jadibot!')
  ...
  //let parent = args[0] && args[0] == 'plz' ? conn : global.conn
    ...
    let authFile = 'sessions'+m.sender.split`@`[0]+'.jadibot.json'
